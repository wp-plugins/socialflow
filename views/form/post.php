			...
			<tr valign="top" class="field socialflow-user-advanced">
				...
				<td>
					<select class="publish-option" id="sf_publish_option<?php echo esc_attr( $user_id ); ?>" name="socialflow[<?php echo esc_attr( $user_id ); ?>][publish_option]">
						<option value="optimize" <?php selected( $publish_option, 'optimize' ); ?>><?php esc_html_e( 'Optimize', 'socialflow' ); ?></option>
						<option value="publish now" <?php selected( $publish_option, 'publish now' ); ?>><?php esc_html_e( 'Publish Now', 'socialflow' ); ?></option>
						<option value="hold" <?php selected( $publish_option, 'hold' ); ?>><?php esc_html_e( 'Hold', 'socialflow' ); ?></option>
						<option value="schedule" <?php selected( $publish_option, 'schedule' ); ?>><?php esc_html_e( 'Schedule', 'socialflow' ); ?></option>
					</select>
					...
					<span class="optimize">
						...
						<select class="optimize-period" name="socialflow[<?php echo esc_attr( $user_id ); ?>][optimize_period]">
							<option <?php selected( $optimize_period, '10 minutes' ); ?> value="10 minutes" ><?php esc_html_e( '1 hour', 'socialflow' ); ?>x</option>
							<option <?php selected( $optimize_period, '1 hour' ); ?> value="1 hour"><?php esc_html_e( '1 hour', 'socialflow' ); ?></option>
							<option <?php selected( $optimize_period, '1 day' ); ?> value="1 day"><?php esc_html_e( '1 day', 'socialflow' ); ?></option>
							<option <?php selected( $optimize_period, '1 week' ); ?> value="1 week"><?php esc_html_e( '1 week', 'socialflow' ); ?></option>
							<option <?php selected( $optimize_period, 'anytime' ); ?> value="anytime"><?php esc_html_e( 'Anytime', 'socialflow' ); ?></option>
							<option <?php selected( $optimize_period, 'range' ); ?> value="range"><?php esc_html_e( 'Pick a range', 'socialflow' ); ?></option>
						</select>
